<%@ Page Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="Bharath.Users" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Button ID="logoutbutton" float="right" runat="server" Text="Logout" CssClass="btn btn-primary" OnClick="Logout"  />
    <div class="jumbotron">
        <h2>Welcome <asp:Label ID="username" runat="server"></asp:Label> to Trip Guide.</h2>
